...
html_files <- list.files("../ESS_APC_HTML/",pattern = "html$")

## correct order and only include important ones
# dput(html_files)
html_files <- c("01-preprocessing.html", "02-sample_description.html",
                "03an-life_satisfaction---KopieLukas.html",
                "03des-life_satisfaction-descriptive---KopieLukas.html", 
                "04an-trust_in_politics.html", 
                "04des-trust_in_politics-descriptive.html"
                )

# Custom tab labels
tab_labels <- c("Aufbereitung", "Variablen Beschreibung",
                "Analyse Lebenszufriedenheit", 
                "Deskription Lebenszufriedenheit",
                "Analyse Vertrauen in Politik", 
                "Deskription Vertrauen in Politik"
                )
